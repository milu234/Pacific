...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../css/notif-styles.css">
  <style type="text/css">
    .modal{
      display: block;
      position: fixed;
  ...
  <section class="projectinfo">
      <?php
        if (isset($_GET['project_id'])){
          ...
          $query = "SELECT task_id, task_title, email,completed, deadline from tasks t, users u
      ...
      <div class="col-twelve">
        <div class="card-header">
          <h3>Project Information</h3>
            ...
            <?php }else{?>
              <h3>Project sent for evaluation.</h3>
            <?php } ?>
        </div>
      ...
      <div class="modal-background" id="modal2-background">
        <div class="modal" align="center">
          ...
          <form method="post" id="assign-task-form" action="../php/add_task.php">
              ...
              ?>
              <input type="date" name="deadline" value="<?php echo date("Y-m-d")?>" min="<?php echo date("Y-m-d")?>" required><br>
              <input type="hidden" name="project_id" value="<?php echo $_GET['project_id']?>">
