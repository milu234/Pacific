...
<body id="top">
	...
	$result2 = mysqli_query($conn,"SELECT distinct  u.name,a.assignment_marks from users u,assignments a where a.class_id = u.class_id and u.class_id=$id and u.role_id = 1 and assignment_id=$id2  ");//for displaying the students of class who are submitting the assignments
