...
<div id="id1" class="modal">
      ...
      <span id="span1" class="close">&times;</span>
         <div class="container">
            ...
            <hr>
            <div class="formrow">
               <div class="col-three"><label for="name"><b>Name</b></label></div>
               <div class="col-nine"><input type="text" placeholder="Enter your name" name="name"  required></div>
            </div>
            <div class="formrow">
...
function initMap() {
  ...
  var marker = new google.maps.Marker({position: uluru, map: map});
   ...
   <script type="text/javascript">
       var status = "<?php  if(isset($_SESSION['registration_success']))
